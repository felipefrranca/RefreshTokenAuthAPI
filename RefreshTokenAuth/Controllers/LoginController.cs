...
namespace RefreshTokenAuth.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        {
            var principal = TokenService.GetPrincipalFromExpiredToken(token); // pega todos os claims do token
            var username = principal.Identity.Name;
            var savedRefreshToken = TokenService.GetRefreshToken(username); // pega o refreshToken que está salvo
